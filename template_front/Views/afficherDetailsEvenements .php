...
<?php if($evenement['note']==3)  {  ?>
			...
			<div class="col-md-0 col-sm-6 co-xs-12 text-center"><button class="btn btn-warning"><a href="ajouterParticipation.php?id_eve=<?php echo $evenement['id_eve']; ?>" name="id_eve">PARTICIPER</a></button><button class="btn btn-success"><a href="add_rate.php?id_eve=<?php echo $evenement['id_eve']; ?>" name="id_eve">NOTER</a></button>
