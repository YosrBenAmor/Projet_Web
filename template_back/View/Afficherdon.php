    ...
    <div class="wrapper">
        ...
        <tr>
            ...
            <div class="card-body text-center">
                                <div class="mb-3">
                                <td><button class="align-middle me-2" ></button> 
                                
                               <button><i class="align-middle me-2" ><span role="img" aria-label="no"><a href="Supprimerdon.php?id_don=<?PHP echo $don['id_don']; ?>">x</span></a></i></button>
                                 </td>
        ...
        ?>
                                            ...
                                            <div class="card-body text-center">
                                <div class="mb-3">
                                <td>    <a href="ajouterdon.php">  <button class="btn btn-success" >Ajouter</a></button></td>
