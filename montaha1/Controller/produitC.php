...
function recupererproduit($id_produit){
 ...
 public function getprodById($id_produit) {
  ...
  function recherche($search_value)
        ...
        {
            $sql = "SELECT * from produit WHERE categorie='machines salle de sport' ORDER BY prix DESC";
            $db = config::getConnexion();
            try {
                $req = $db->query($sql);
                return $req;
        ...
        {
            $sql = "SELECT * from produit WHERE categorie='plastique' ORDER BY prix DESC";
            $db = config::getConnexion();
            try {
                $req = $db->query($sql);
                return $req;
        ...
        {
            $sql = "SELECT * from produit WHERE categorie='bicyclette' ORDER BY prix DESC";
            $db = config::getConnexion();
            try {
                $req = $db->query($sql);
                return $req;
