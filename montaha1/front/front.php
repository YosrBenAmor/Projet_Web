                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong style="color:red ;">Liste des categories :</strong>
                            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div id="product-1" class="single-product">
                    ...
                    <?PHP echo "<img   src='../View/assets/images/".$row['image']."' >"; ?>
                       <style>
						.part-1 :hover{
    transform: scale(1.1);/*kabert 10% f taille*/  	
}
                    ...
                    <div class="part-2">
                    <h2 style="color: #8fbc8f	;" class="card-title"><?php echo $row['nom_categ'];?></h2>
                    <ul style="color:#483d8b ;"  class="list-group list-group-flush">
    <li class="list-group-item">Id_Categorie : <?php echo $row['id_categ'];?></li>    
    <li class="list-group-item">Description : <?php echo $row['descriptionc'];?></li>
		...
		<div class="card-body">
					...
					<a  type="button" class="btn btn-default btn-sm"  href="../front/MSS.php"> voir le(s) élément(s):</a>
			...
			<button   type="button" 
                    class="btn btn-default btn-sm">
					<a  type="button" class="btn btn-default btn-sm" href="../front/bicyclette.php">voir le(s) élément(s):</a>
			...
			<button  type="button" 
                    class="btn btn-default btn-sm">					
					<a  type="button" class="btn btn-default btn-sm" href="../front/plastique.php">voir le(s) élément(s):</a>
			...
			<style>
				...
				button :hover{
                    transform: scale(1.1);/*kabert 10% f taille mtaa el button */  	
