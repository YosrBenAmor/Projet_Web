...
if (isset($_GET['label']) && !empty($_GET['label'])) {
    $Listereservation = $reservation->afficherListereservations($_GET['label']);
} else {
    $Listereservation= $reservation->afficherListereservations();
}
?>
<html>
...
<body>
    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="pages-profile.html">
                            <i class="align-middle" data-feather="reservation"></i> <span class="align-middle">Profile</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="pages-sign-up.html">
                            <i class="align-middle" data-feather="reservation-plus"></i> <span class="align-middle">Sign
                                Up</span>
                        </a>
                    </li>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                                ...
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <i class="text-success" data-feather="reservation-plus"></i>
                                            </div>
                                            <div class="col-10">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="pages-profile.html"><i class="align-middle me-1"
                                        data-feather="reservation"></i> Profile</a>
        ...
        <form action="" method="GET">
            <input type="text" name="label" id="label" placeholder="donner le ID de reservation ">
        ...
        <tr>
            ...
            <td><?php echo $reservation['reff']; ?></td>
           
            <div class="card-body text-center">
                                <div class="mb-3">
  
                                
                                <td>  <button class="align-middle me-2" ><a href="supprimerreservation.php?id=<?php echo $reservation['id']; ?>">x</a></button></td>
