...
if (isset($_POST['search2'])) 
{
    ...
    {
        $listereservations=$reservationC->rechercherListereservation($_POST['search1']);
    }
}
else
  $listereservations=$reservationC->tridecroissant();  
    ...
    <section class="page-banner">
        <div class="container">
            <div class="page-banner-content">
                <h2>reservations</h2>
                <p><a href="index-2.html">Home</a> / reservations</p>
            </div>
        </div>
    </section>
    <!-- End Page banner -->
    ...
    <section class="tours-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <?PHP foreach($listereservations as $row){?>
                        ...
                        <form action="singlecirc.php" method="post">
                            ...
                            <div class="tours-item">
                                ...
                                <div class="tours-image">
                                    <a name="aa" value="<?PHP echo $row['idreservation']; ?>" >
                                        <img class="imgreservation" src="../entities/img/<?PHP echo $row['photo']; ?>">
                                    </a>
                                    <input type="text" name="idreservation" value="<?PHP echo $row['idreservation']; ?>" hidden>
                                </div>
                                ...
                                <div class="tours-content">
                                    ...
                                    <h3>
                                        ...
                                        <a value="<?PHP echo $row['idreservation']; ?> ">
                                          Nom reservation:  <?PHP echo $row['nom_reservation']; ?></a>
                                    </h3>
                    ...
                    <div class="tours-sidebar">
                        ...
                        <div class="tours-form">
                            <form name="f1" method="post">
                                <input type="text" class="form-control" placeholder="Search reservation" name="search1">
