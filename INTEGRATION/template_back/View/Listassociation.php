...
<div class="wrapper">
        ...
        <tr>
            ...
            <td><?php echo $association['email_ass']; ?></td>
                <td>
                    <a href="updateassociation.php?id_ass=<?php echo $association['id_ass']; ?>" name="id_ass" >Modifier</a>

                
                
                    <a href="deleteassociation.php?id_ass=<?php echo $association['id_ass']; ?>">Supprimer</a>
                </td>
                </div>
        </div>
           ...
           ?>
                                   ...
                                   <div class="mb-3">
                                   <td>    <a href="addassociation.php">  <button class="btn btn-success" >Ajouter</a></button></td>
