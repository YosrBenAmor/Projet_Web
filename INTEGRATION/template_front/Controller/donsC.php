...
class donC
{
    ...
    function adddon($don)
    {
        $sql = "INSERT INTO don  (id_don, nom_don, img_don,num_tel,email_don,id_ass,id)
        VALUES (:id_don,:nom_don,:img_don,:num_tel,:email_don,:id_ass,:id)";
        $db = config::getConnexion();
        try {
