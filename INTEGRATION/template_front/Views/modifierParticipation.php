		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<form action="" method="POST"  name="mayssa" onsubmit="return validateForm(event)" >
                                    ...
                                    <div class="fields">
										<div class="field half">
											...
											<div class="field">
												...
												<input type="text" class="form-control" placeholder="Prénom du participant" id="prenom_part" name="prenom_part" value="<?php echo $participation['prenom_part']; ?>" />
											</div>
                        ...
                        <input class="btn btn-success" type="submit" value="Envoyer"> <a href="afficherListeParticipation.php?id=<?php  echo $_SESSION['id']; ?>"></a> 
