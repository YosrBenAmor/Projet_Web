									...
									<div class="fields">
										<div class="field half">
											...
											<div class="field">
												...
												<input type=text  class ="form-control"name="num_tel" id="num_tel" value="<?php echo $_SESSION['tel'];?>"/>
											...
											<div class="field">
												...
												<input type=text  class ="form-control" name="email_don" id="email_don" value="<?php echo $_SESSION['email'];?>"/>
