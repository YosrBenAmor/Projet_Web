...
<html>
    ...
    transform: scale(1.1);/*kabert 10% f taille*/  	
                    ...
                    <div class="part-2">
                    <h2 class="card-title"><?php echo $row['nom_categ'];?></h2>
		...
		<div class="card-body">
					...
					<a  type="button" class="btn btn-default btn-sm"  href="MSS.php"> voir le(s) élément(s):</a>
			...
			<button   type="button" 
                    class="btn btn-default btn-sm">
					<a  type="button" class="btn btn-default btn-sm" href="bicyclette.php">voir le(s) élément(s):</a>
			...
			<button  type="button" 
                    class="btn btn-default btn-sm">					
					<a  type="button" class="btn btn-default btn-sm" href="plastique.php">voir le(s) élément(s):</a>
