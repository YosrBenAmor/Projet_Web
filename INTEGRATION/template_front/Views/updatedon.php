									...
									<div class="fields">
										<div class="field half">
											...
											<div class="field">
												...
												<input type=text class ="form-control" name="nom_don" id="nom_don" value="<?php echo $don['nom_don']; ?>"/>
												<p id="errorNA" class=error>
											</div>
											
											<div class="field">
												<label for="img_don">IMAGE DU DON</label>
												<input type=text  class ="form-control" name="img_don" id="img_don" value="<?php echo $don['img_don']; ?>"/>
												
											</div>
											<div class="field">
												<label for="num_tel">VOTRE NUMÈRO DU TÈLÈPHONE</label>
												<input type=text  class ="form-control"name="num_tel" id="num_tel" value="<?php echo $don['num_tel']; ?>"/>
												<p id=errorNU class=error>
											</div>
						
											<div class="field">
												<label for="email_don">VOTRE ÈMAIL </label>
												<input type=text  class ="form-control" name="email_don" id="email_don" value="<?php echo $don['email_don']; ?>"/>
										...
										<div class="field half text-right">
											<ul class="actions"><br>
												<li><input class="btn btn-success" type="submit" value="Modifier"  /></li>
											</ul>
										</div>
									</div>
								</form>
