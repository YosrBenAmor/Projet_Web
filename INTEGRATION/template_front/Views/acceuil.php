			...
			<div id="wrapper">
				...
				<!-- Banner -->
					<section id="banner" class="major">
						<div class="inner">
							<header class="major">
								<h1>Bienvenue chez Tetdallel
								</h1>
							</header>
							<div class="content">
								<p>commencez a troquer! </p>
								<ul class="actions">
									<li><a href="login.php" class="button next scrolly">Se connecter</a></li>
								</ul>
								<br>
								<br>
								<ul class="actions">
									<li><a href="ajouterUser.php" class="button next scrolly">Créer un compte</a></li>
								</ul>
							</div>
						</div>
					</section>
