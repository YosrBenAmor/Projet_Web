...
$listeproduit=$produit->afficherproduitbicyclette();
...
<!-- tri -->
<div>
                <a class="btn btn-success" href="bicyclette_trier.php?id_produit=<?PHP echo $row['nom_produit']; ?>"> Trier par nombre de points </a>
